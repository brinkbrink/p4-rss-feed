...
$sub_folder = 'IT262wn22/winter_2022/';//If app installed in subfolder, place here.  name of folder, no leading or trailing forward or backslash
...
define('SUPPORT_EMAIL', 'clareswensen@gmail.com'); # Email of site support
define('PREFIX', 'winter2022_'); #Adds uniqueness to DB table names.  Limits hackability, naming collisions.  In WordPress the prefix is wp_
...
$nav1['categories/index.php'] = "News~RSS news feeds";
